...
setwd("/Users/zhulin/Desktop/hw05")
create_package("nbaPlayers") #Creates a new package via devtools 
...
setwd("/Users/zhulin/Desktop/hw05/nbaPlayers/R") #Assumes you are currently using R working directory.
